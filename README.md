...
　　※A small number of photos were resized, luminosity changed, and rotated to increase the number.Labeling range specification was automated by detecting the edge of the piece.
